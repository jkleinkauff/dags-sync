...
k = KubernetesPodOperator(
    ...
    arguments=[
        ...
        "--conf",
        "spark.driver.extraJavaOptions='-Divy.cache.dir=/tmp -Divy.home=/tmp -Djava.io.tmpdir=/tmp'",
        "--conf",
        "spark.executor.extraJavaOptions='-Divy.cache.dir=/tmp -Divy.home=/tmp -Djava.io.tmpdir=/tmp'",
        "--conf",
